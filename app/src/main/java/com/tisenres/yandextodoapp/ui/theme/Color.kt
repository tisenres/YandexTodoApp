...
// Light theme colors
val LightSeparator = Color(0xFFB7B7B7)
val LightOverlay = Color(0xFFD8D8D8)

val LightPrimaryLabel = Color(0xDE000000)
val LightSecondaryLabel = Color(0xFF5C5C5C)
val LightTertiaryLabel = Color(0xFFA0A0A0)
val LightDisableLabel = Color(0xFFC3C3C3)
...
// Dark theme colors
val DarkSeparator = Color(0xFFEAEAEA)
val DarkOverlay = Color(0xFF9B9B9B)

val DarkPrimaryLabel = Color(0xFFFFFFFF)
val DarkSecondaryLabel = Color(0xFFF5F5F5)
val DarkTertiaryLabel = Color(0xFFEFEFEF)
val DarkDisableLabel = Color(0xFFE9E9E9)
...
val DarkSecondaryBackground = Color(0x25252528)
